...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- form start -->
        <form role="form" class="form-horizontal" method="GET" action="modules/lap-brg-masuk/cetak.php" target="_blank">
          <div class="box-body">
  ...
  <h1>
    ...
    <a class="btn btn-primary btn-social pull-right" href="modules/lap-brg-masuk/cetakall.php" target="_blank">
      <i class="fa fa-print"></i> Cetak
    </a>
  </h1>
