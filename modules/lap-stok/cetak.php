...
$query = mysqli_query($mysqli, "SELECT kode_brg,nama_brg,harga_beli,harga_jual,satuan,stok FROM is_brg ORDER BY nama_brg ASC")
                                or die('Ada kesalahan pada query tampil Data brg: '.mysqli_error($mysqli));
$count  = mysqli_num_rows($query);
?>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
        <title>PT. Purna Usaha Mandiri (stok)</title>
...
<?php
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td style='padding-left:5px;' width='180' height='13' valign='middle'>$data[nama_brg]</td>
