...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO is_brg_masuk(kode_transaksi,tanggal_masuk,kode_brg,jumlah_masuk,created_user) 
                                            VALUES('$kode_transaksi','$tanggal_masuk','$kode_brg','$jumlah_masuk','$created_user')")
            ...
            if ($query) {
                ...
                if ($query1) {                       
                    ...
                    header("location: ../../main.php?module=brg_masuk&alert=1");
                }
            }   
        }   
    }
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            $query = mysqli_query($mysqli, "DELETE FROM is_brg_masuk WHERE kode_transaksi='$kode_transaksi'")
                                            or die('Ada kesalahan pada query delete : '.mysqli_error($mysqli));

            // cek hasil query
            if ($query) {
                // jika berhasil tampilkan pesan berhasil delete data
                header("location: ../../main.php?module=brg_masuk");
            }
        }
    }
}       
