...
<section class="content-header">
  <h1>
    <i class="fa fa-sign-out icon-title"></i> Data brg Keluar

    <a class="btn btn-primary btn-social pull-right" href="?module=form_brg_keluar&form=add" title="Tambah Data" data-toggle="tooltip">
  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 1) {
      echo "<div class='alert alert-success alert-dismissable'>
              ...
              Data brg Keluar berhasil disimpan.
            </div>";
    }
    ?>
        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_keluar,a.kode_brg,a.jumlah_keluar,b.kode_brg,b.nama_brg,b.satuan
                                            FROM is_brg_keluar as a INNER JOIN is_brg as b ON a.kode_brg=b.kode_brg ORDER BY kode_transaksi DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td class='center' width='80'>
                        <div>                         
                          "?>
                          <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="modules/brg-keluar/proses.php?act=delete&id=<?php echo $data['kode_transaksi'];?>" onclick="return confirm('Anda yakin ingin menghapus data Barang Keluar <?php echo $data['kode_transaksi']; ?> ?');">
