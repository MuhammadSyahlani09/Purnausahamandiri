...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | PT. Purna Usaha Mandiri</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Persediaan Barang PT.Purna Usaha Mandiri">
    <meta name="author" content="PT.Purna Usaha Mandiri" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:5px;" src="assets/img/logo1.png" alt="Logo" height="35"> 
          <span style="font-size:30px">PT</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2023 - PT.Purna Usaha Mandiri</a></strong>
      </footer>
    </div><!-- ./wrapper -->
